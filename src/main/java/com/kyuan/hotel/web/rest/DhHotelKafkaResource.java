...
@RestController
@RequestMapping("/api/dh-hotel-kafka")
public class DhHotelKafkaResource {
    private final Logger log = LoggerFactory.getLogger(DhHotelKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DhHotelKafkaResource(KafkaProperties kafkaProperties) {
